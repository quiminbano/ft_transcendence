...
urlpatterns = [
    ...
    path("addFriend/<str:friendName>", views.userController.friends, name="addFriend"),
    path("removeFriend/<str:friendName>", views.userController.friends, name="removeFriend"),
